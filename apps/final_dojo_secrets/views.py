...
def index(request):
    ...
    return render(request, 'final_dojo_secrets/index.html', context)
...
def secrets(request):
    ...
    return render(request, 'final_dojo_secrets/secrets.html', context)
...
def popular(request):
    ...
    return render(request, 'final_dojo_secrets/popular.html', context)
...
def delete(request, id, sentby):
    print "we are in the delete method", id
...
def users(request):
    ...
    return render(request, 'final_dojo_secrets/users.html', context)
...
def user(request, id):
    ...
    return render(request, 'final_dojo_secrets/user.html', context)
